...
function EventHandlersConditions() {
  ...
  function handleA() { 
    ...
    // if timesClicked is not even. The first click will indicate that it is odd because it starts from 0.
    if (timesClicked % 2 !== 0 ) { 
...
export default EventHandlersConditions;
